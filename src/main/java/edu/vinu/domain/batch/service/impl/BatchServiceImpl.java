...
public class BatchServiceImpl implements BatchService {
    ...
    public Batch createBatch(BatchCreateRequest request) {
        ...
        return createBatch(courseEntity,request);
    }

    @Transactional
    @Override
    public Batch createBatch(CourseEntity courseEntity, BatchCreateRequest request) {
        ...
        eventPublisher.publishEvent(new BatchCreatedEvent(courseEntity.getInstitute().getId()));
        return savedBatch;
    }
    ...
    public Batch updateBatchById(Long batchId, BatchUpdateRequest request) {
        ...
        eventPublisher.publishEvent(new BatchUpdateEvent(savedBatchEntity.getCourse().getInstitute().getId()));
        return savedBatch;
    }
